class Token:
    def __init__(self, token_index_in_sentence, text, pos_tag=None, iwnlp_lemma=None, polarity=None, spacy_pos_stts=None,
                 spacy_pos_universal_google=None, spacy_ner_type=None, spacy_ner_iob=None, spacy_shape=None, spacy_is_punct=None,
                 spacy_like_url=None, spacy_like_num=None, spacy_is_space=None, polarity_sentiws=None):
