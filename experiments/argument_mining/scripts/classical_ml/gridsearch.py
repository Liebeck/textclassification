...
from frameworks.tc_scikit.evaluation.gridsearch_report import report_best_results, best_cv_result
...
from frameworks.tc_scikit.representations.word2vec import Word2Vec
from frameworks.tc_scikit.strategies.gridsearch import GRIDSEARCH_STRATEGIES
...
if __name__ == '__main__':
    ...
    if arguments.jobid:
        output_path = 'experiments/argument_mining/results/sentence/temp/{}_{}_{}_{}_{}'.format(settings['subtask'], settings['classifier'],
